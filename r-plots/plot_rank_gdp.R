...
OUT <- PDATA$data_base_lp_gdp %>% 
  ...
  xlab("") +
  ylab("GDP, ($ Trillion US)") +
  ggtitle("Responsibility 4: GDP 2019", subtitle = "Highest GDP, China, US, EU-27 & Reference for GDP, Population and Emissions")+
  annotate("text", x=(which(fct_inorder(PDATA$p_an_gdp)==PDATA$ghg_50_gdp$country)), y=PDATA$data_base_lp_gdp$y[3]*0.8, 
