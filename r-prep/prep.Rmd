...
data_base = data_gwp100 %>%
  ...
  mutate(
    ...
    woc = country != "China",
    deving_woc = woc & data_base$region_ar6_dev == "developing",
    deved = data_base$region_ar6_dev == "developed",
    adp_region_woc = woc & data_base$region_ar6_6 == "Asia and developing Pacific",
...
data_kaya = data_base %>% 
  group_by(ISO,country,year,GDP_pc,pop) %>% 
